...
|---------|-------|---------|
| Main Client | [`HiveMQClient`](/docs/hivemqtt/hivemqclient) | — |
| Performance Client | [`RawClient`](/docs/rawclient/intro) (Beta) | — |
...
- [Connecting](/docs/hivemqtt/connecting) - Connection options and TLS configuration
- [Publishing](/docs/hivemqtt/publishing) - Message publishing options
- [Subscribing](/docs/hivemqtt/subscribing) - Subscription management and callbacks
- [Events](/docs/hivemqtt/events) - Hook into client lifecycle events
- [HiveMQClient Reference](/docs/hivemqtt/hivemqclient) - Complete client documentation
