...
* `ReasonCode`: Gets or sets the reason code for the disconnection. The default value is `NormalDisconnection`.
	+ Possible values are detailed in [DisconnectReasonCode enum](https://github.com/hivemq/hivemq-mqtt-client-dotnet/blob/main/Source/HiveMQtt/MQTT5/ReasonCodes/DisconnectReasonCode.cs).
