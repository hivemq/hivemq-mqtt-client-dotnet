...
* [Security Best Practices](/docs/hivemqtt/security) - Comprehensive security guide
* [HiveMQClientOptionsBuilder Reference](/docs/hivemqtt/reference/client_options_builder)
* [Automatic Reconnect](/docs/hivemqtt/reference/automatic_reconnect)
* [How to Set a Last Will & Testament](/docs/hivemqtt/how-to/set-lwt)
* [Connect with TLS but allow Invalid TLS Certificates](/docs/hivemqtt/how-to/allow-invalid-certs)
* [Securely Connect to a Broker with Basic Authentication Credentials](/docs/hivemqtt/how-to/connect-with-auth)
* [Custom Client Certificates](/docs/hivemqtt/how-to/client-certificates)
