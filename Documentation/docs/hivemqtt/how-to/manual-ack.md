...
* [HiveMQClientOptions Reference](/docs/hivemqtt/reference/client_options) — `ManualAckEnabled`
* [HiveMQClientOptionsBuilder Reference](/docs/hivemqtt/reference/client_options_builder) — `WithManualAck`
* [Lifecycle Events](/docs/hivemqtt/events) — `OnMessageReceived` and event args
