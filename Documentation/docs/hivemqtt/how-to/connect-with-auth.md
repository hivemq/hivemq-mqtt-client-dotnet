...
For enhanced security, use `SecureString` to prevent password exposure in memory. See the [Security Best Practices](/docs/hivemqtt/security#securestring-for-credentials) guide for details.
:::
...
- [Security Best Practices](/docs/hivemqtt/security) - Comprehensive security guide including SecureString usage
...
- [Client Certificates](/docs/hivemqtt/how-to/client-certificates) - Certificate-based authentication
