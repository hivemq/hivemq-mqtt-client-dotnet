...
* [Connecting to a Broker](/docs/hivemqtt/connecting) - Basic connection setup
* [Security Best Practices](/docs/hivemqtt/security) - TLS and authentication
* [HiveMQClientOptionsBuilder Reference](/docs/hivemqtt/reference/client_options_builder) - All builder methods
* [HiveMQClientOptions Reference](/docs/hivemqtt/reference/client_options) - All configuration options
